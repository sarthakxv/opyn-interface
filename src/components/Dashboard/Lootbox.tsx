...
const Lootbox = () => (
  <div className="flex flex-col sm:flex-row items-center sm:justify-between py-5 px-10 mx-14 border border-[#8D8D8D] rounded-lg w-full max-w-[256px] md:max-w-[768px] xl:max-w-[1280px] 2xl:max-w-[1536px]">
