...
const ClaimXP = () => (
  <div className="grid grid-rows-1 md:grid-rows-2 lg:grid-rows-none grid-cols-none lg:grid-cols-3 gap-4 min-h-full">
    ...
    <div className="col-span-1 flex flex-col items-center gap-6">
      <Stats title="Community XP" xp="2500" image="/images/CommunityXP.svg" />
  ...
  <Card className="flex flex-col justify-between pt-4 pb-9 px-8">
    ...
    <div className="flex flex-col">
      <p className="inline-flex items-center justify-between w-full">
        ...
        <span className="font-normal text-sm leading-4">120 out of 500</span>
      </p>
      <div className="-ml-2">
        <Image
    ...
    <div className="flex flex-col">
      <p className="inline-flex items-center justify-between w-full">
        ...
        <span className="font-normal text-sm leading-4">10 out of 26</span>
      </p>
      <div className="-ml-2">
        <Image
          src="/images/Progress.svg"
    ...
    <div className="flex flex-col">
      <p className="inline-flex items-center justify-between w-full">
        ...
        <span className="font-normal text-sm leading-4">30 out of 54</span>
      </p>
      <div className="-ml-2">
        <Image
          src="/images/Progress.svg"
    ...
    <div aria-label="online-section" className="mb-6">
      ...
      <div className="flex flex-col gap-5 w-full">
        {onlineUsers.map((user, index) => (
          ...
          >
            <Image alt={user.name} height={52} width={52} src={user.profile} />
